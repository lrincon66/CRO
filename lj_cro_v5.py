...
r_grid = 0.6*np.power(float(atoms),1.0/3.0) #radius for an spherical grid multiplied by 40% more
r_grid_atom = 0.3 #half side of the grid for directed montecarlo
...
for cro in range(N):
    ...
    print(cro,MinPotentialEnergy,ActualMinPotentialEnergy,PopSize,buffer)
